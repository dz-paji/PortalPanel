...
<body>
  ...
  <div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container">
        <br><br>
        <h1 class="header center teal-text text-lighten-6">微距教育</h1>
        <div class="row center">
          <h5 class="header col s12 light">华北地区首个高中生自主创办的国际青年论坛</h5>
        </div>
        <div class="row center">
      ...
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">在微距，你能了解到普通高中教育中，从未涉及到的知识</p>
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">在微距，你可以找到与你志向相同的朋友</p>
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">化妆舞会、玻璃鱼缸、鸡尾酒调制，总有一个会符合你的口味</p>
          </div>
        </div>
      </div>
  ...
  <div class="parallax-container valign-wrapper">
    <div class="section no-pad-bot">
      <div class="container">
        <div class="row center">
          <h5 class="header col s12 light">在你来到这里之前，不会体会到微距的快乐</h5>
        </div>
      </div>
    </div>
  ...
  <div class="row">
        <div class="col s12 center">
          ...
          <div class="row center">
              <a href="#" id="download-button" class="btn-large waves-effect waves-light wine-red lighten-1">新闻站</a>
            </div>
