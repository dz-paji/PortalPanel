                ...
                <div class="panel-body">
                    ...
                    <form action="{{ url('projects') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="desc" class="materialize-textarea" name="desc" required="required"></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="desc" class="materialize-textarea" name="desc2" required="required"></textarea>
